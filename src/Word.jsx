...
const Word = () => {
  ...
  useEffect(() => {
    axios.get("https://collectionapi.metmuseum.org/public/collection/v1/objects/2762")
...
return (
    <>
     <div style={{ marginBottom: 16 }}>
        <Link to="/login">Go to Previous Slide</Link>
         <p></p>
        <Link to="/ninja">Go to Next Slide</Link>
      </div>
